...
var QuickSidebar = function () {
    ...
    var handleQuickSidebarChat = function () {
        ...
        /*wrapper.find('.page-quick-sidebar-chat-users .media-list.responsables > .media').click(function () {
            wrapperChat.addClass("page-quick-sidebar-content-item-shown");
        });

        wrapper.find('.page-quick-sidebar-chat-users .media-list.referidos > .media').click(function () {
            wrapperChat.addClass("page-quick-sidebar-content-item-shown");
        });*/
